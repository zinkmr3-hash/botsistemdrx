...
// @grant        none
// @updateURL    https://raw.githubusercontent.com/zinkmr3-hash/botsistemdrx/main/auto-adlogs-v38.1.js
// @downloadURL  https://raw.githubusercontent.com/zinkmr3-hash/botsistemdrx/main/auto-adlogs-v38.1.js
    ...
    async function proses(){
        ...
        try{
            ...
            for(let i of items){
                ...
                if(label.includes('catatan') && textarea) setVal(textarea, `NO RESPON ${level}`);
            }
            await klikSimpan();
