// ==UserScript==
// @name         WIDA-Auto-adlogs-V38.1.user.js
...
// @grant        none
// @updateURL    https://raw.githubusercontent.com/zinkmr3-hash/botsistemdrx/refs/heads/main/WIDA-Auto-adlogs-V38.1.user.js
// @downloadURL  https://raw.githubusercontent.com/zinkmr3-hash/botsistemdrx/refs/heads/main/WIDA-Auto-adlogs-V38.1.user.js
        ...
        try{
            ...
            for(let i of items){
                ...
                // UPDATE: "waktu tindak lanjut berikutnya" tidak lagi diisi — dilewati
                    ...
                    const catatanList = ['tidak respon', 'tidak aktif', 'kd menyampaikan', 'kd tidak aktif', 'kd tdk mengenal'];
                    const randomCatatan = catatanList[Math.floor(Math.random() * catatanList.length)];
                    setVal(textarea, randomCatatan);
                }
            }
            await klikSimpan();
